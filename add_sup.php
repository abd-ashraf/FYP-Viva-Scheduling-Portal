                            ...
                            <?php
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="sup_add_php.php" method="post" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">  
                                                    <label for="sup_ID" class=" form-control-label">Supervisor ID</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="sup_ID" name="sup_ID" placeholder="Enter New Supervisor ID" class="form-control" required>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="sup_name" name="sup_name" placeholder="Enter Supervisor Name" class="form-control" required>
                                                </div>
                                            </div>
                                            <br>
