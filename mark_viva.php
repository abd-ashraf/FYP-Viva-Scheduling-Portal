...
<?php
    ...
    $id = "$_GET[id]";
    $sql = "SELECT * FROM viva WHERE viva_ID='$id';";
    $result = $conn->query($sql);
    $data = $result->fetch_assoc();
    $sup_ID = $data['supervisor_ID'];
    $group_ID = $data['group_ID'];
	    	?>
                <form action="enter_marks.php?sup_id=<?php echo $sup_ID; ?>&group_id=<?php echo $group_ID; ?>" method="post" class="form-horizontal">
                    <div class="row form-group">
                        <div class="col col-md-3">  
                            <label for="stu_ID" class=" form-control-label">Total Marks</label>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">  
                            <label for="stu_ID" class=" form-control-label">Obtained Marks</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="number" id="stu_ID" name="obtained" class="form-control" required>
                        </div>
                    </div>
                    <br>
